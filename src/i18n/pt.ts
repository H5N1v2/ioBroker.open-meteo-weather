export const pt = {
	...
	time: 'Hora',
	date: 'Data',
	pressure_msl: 'Presão da superficie',
	pressure_msl_mean: 'Presão media da superficie',
	wind_gust_icon: 'Icono de rajadas de vento',
	wind_direction_icon: 'Icono da direção do vento',
	...
	et0_fao_evapotranspiration: 'Evapotranspiração',
	et0_fao_evapotranspiration_sum: 'Evapotranspiração Total',
	...
	relative_humidity_2m_mean: 'Humidade relativa média (2m)',
	...
	olive_pollen: 'Pólen de oliveira',
	olive_pollen_text: 'Níveis de pólen de oliveira',
	ozone: 'Ozono',
	ragweed_pollen_text: 'Carga de pólen de ambrósia',
	mugwort_pollen_text: 'Carga de pólen de artemísia',
	grass_pollen_text: 'Carga de pólen de gramíneas',
	birch_pollen_text: 'Carga de pólen de bétula',
	alder_pollen_text: 'Carga de pólen de aliso',
	alder_pollen_max: 'Pólen de Alno Máx.',
	birch_pollen_max: 'Pólen de Bétula Máx.',
	carbon_monoxide_max: 'Monóxido de Carbono Máx.',
	dust_max: 'Poeira Máx.',
	grass_pollen_max: 'Pólen de Gramíneas Máx.',
	mugwort_pollen_max: 'Pólen de Artemísia Máx.',
	nitrogen_dioxide_max: 'Dióxido de Nitrogênio Máx.',
	olive_pollen_max: 'Pólen de Oliveira Máx.',
	ozone_max: 'Ozono Máx.',
	pm10_max: 'PM10 Máx.',
	pm2_5_max: 'PM2.5 Máx.',
	ragweed_pollen_max: 'Pólen de Ambrósia Máx.',
	interval: 'Intervalo',
