...
const nl = {
  ...
  relative_humidity_2m_mean: "Gemiddelde relatieve luchtvochtigheid (2m)",
  ...
  olive_pollen: "Olijfpollen",
  olive_pollen_text: "Olijfpollen niveaus",
  ozone: "Ozon",
  ...
  alder_pollen_max: "Elzenpollen Max.",
  birch_pollen_max: "Berkenpollen Max.",
  carbon_monoxide_max: "Koolmonoxide Max.",
  dust_max: "Stof Max.",
  grass_pollen_max: "Graspollen Max.",
  mugwort_pollen_max: "Bijvoetpollen Max.",
  nitrogen_dioxide_max: "Stikstofdioxide Max.",
  olive_pollen_max: "Olijfpollen Max.",
  ozone_max: "Ozon Max.",
  pm10_max: "PM10 Max.",
  pm2_5_max: "PM2.5 Max.",
